...
DEFAULT_EXPECTED_PRIMARY_MODEL="${OPENCLAW_DAILY_UPDATE_EXPECTED_PRIMARY_MODEL:-qmcode/gpt-5.4}"
DEFAULT_EXPECTED_FALLBACKS_JSON="${OPENCLAW_DAILY_UPDATE_EXPECTED_FALLBACKS_JSON:-[\"qmcode/gpt-5.2\"]}"
