...
HOOK_FILE="$CODEX_HOME/hooks/feishu-notify-on-turn.sh"
...
require_shell_syntax "$HOOK_FILE" "notify hook shell syntax"
...
require_pattern "notify hook failed" "$HOOK_FILE" "notify failure visible logging"
